<template>
  <v-layout>
    <v-dialog v-model="show" width="450">
      <v-card>
		<v-btn icon @click.stop="show=false" class="ma-2 float-right">
			<v-icon>mdi-close</v-icon>
        </v-btn>
        <div v-if="config.iconWaring" class="f-modal-alert">
    ...
    <v-dialog v-model="feedBack" max-width="450">
      <v-card>
        <div class="f-modal-alert">
...
export default {
  ...
  methods: {
    activate() {
    (this.show = false), (this.feedBack = true);
    }, 
  },
  computed: {
    show: {
